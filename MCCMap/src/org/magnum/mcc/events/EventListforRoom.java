...
public class EventListforRoom extends Activity {
	...
	private class Downloadjson extends AsyncTask<String, Integer, String> {
		...
		protected void onPostExecute(String result) {
			...
			listview.setAdapter(new ArrayAdapter<String>(EventListforRoom.this,
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		listview.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				Intent intent = new Intent(EventListforRoom.this,
